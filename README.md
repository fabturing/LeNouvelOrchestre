...
LeNouvelOrchestre est un groupe virtuel de musique improvisée composé de :

* Jiéf : Petit flutiste debout sur un tabouret
...
La musique de ce groupe est produite de manière procédurale et sans IAG.

Le code est principalement écrit en javascript à l'aide des librairies Tone.js et Tonal.js

Le projet est placé sous licence [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/)
